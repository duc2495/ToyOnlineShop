	...
	<div class="content-header">
		<ul class="nav-horizontal text-center">
			...
			<li class="active"><a href="product_edit"><i
					class="gi gi-pencil"></i> Product Edit</a></li>
	...
	<div class="row">
				...
				<s:form action="product_edit" method="post"
					...
					<div class="form-group">
						<label class="col-md-3 control-label"
							for="product-short-description">Short Description</label>
						<div class="col-md-9">
							<textarea id="product-short-description"
								name="product-short-description" class="form-control" rows="3"></textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<select id="product-category" name="product-category"
								class="select-chosen" data-placeholder="Choose Category.."
								style="width: 250px;">
								<option></option>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<label class="radio-inline" for="product-condition-new">
								...
								name="product-condition" value="condition_new" checked>
								New
							</label> <label class="radio-inline" for="product-condition-used">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<label class="switch switch-primary"> <input
								type="checkbox" id="product-status" name="product-status"
								checked><span></span>
							</label>
						</div>
					</div>
		...
		<div class="col-lg-6">
			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						<i class="fa fa-google"></i> <strong>Meta</strong> Data
					</h2>
				</div>
				<!-- END Meta Data Title -->
				...
				<s:form action="product_edit" method="post"
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" id="product-meta-title"
								name="product-meta-title" class="form-control"
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="product-meta-keywords">Meta
							Keywords</label>
						<div class="col-md-9">
							<input type="text" id="product-meta-keywords"
								name="product-meta-keywords" class="form-control"
								placeholder="keyword1, keyword2, keyword3">
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label"
							for="product-meta-description">Meta Description</label>
						<div class="col-md-9">
							<textarea id="product-meta-description"
								name="product-meta-description" class="form-control" rows="6"
			...
			<div class="block">
				...
				<div class="block-title">
					<h2>
						<i class="fa fa-picture-o"></i> <strong>Product</strong> Images
					</h2>
				</div>
				...
				<div class="block-section">
					...
					<form action="product_edit" class="dropzone"></form>
				</div>
						...
						<tr>
							<td style="width: 20%;"><a
								...
								data-toggle="lightbox-image"> <img
									src="img/placeholders/photos/photo11.jpg" alt=""
